...
def center():
    ...
    moveForward(fbDifference/2)
    moveRight(lrDifference/2)
...
def directionalSensorSweep(robotLocation,numberSweeps):
    information = sensorSweep(numberSweeps)
...
def travelToLoadingZone(robotLocation):
    travelling = True
    rowCheck = False
    columnCheck = False
    while travelling:
        ...
        if rowCheck and columnCheck:
            ...
            directionalSensorData = directionalSensorSweep(robotLocation,5)
